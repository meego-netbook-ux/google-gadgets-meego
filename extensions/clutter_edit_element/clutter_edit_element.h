...
#ifndef GGADGET_CLUTTER_EDIT_ELEMENT_H__
#define GGADGET_CLUTTER_EDIT_ELEMENT_H__
...
class ClutterEditElement : public EditElementBase {
 public:
  DEFINE_CLASS_ID(0xc321ec8aeb4142c4, EditElementBase);

  ClutterEditElement(View *view, const char *name);
  virtual ~ClutterEditElement();
 ...
 private:
  ...
  DISALLOW_EVIL_CONSTRUCTORS(ClutterEditElement);

  ClutterEditImpl *impl_;
};

} // namespace clutter
} // namespace ggadget

#endif // GGADGET_CLUTTER_EDIT_ELEMENT_H__
