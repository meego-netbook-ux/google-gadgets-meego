...
#ifndef GGADGET_CLUTTER_SINGLE_VIEW_HOST_H__
#define GGADGET_CLUTTER_SINGLE_VIEW_HOST_H__
...
/**
 * @ingroup GtkLibrary
 * An implementation of @c ViewHostInterface based on Clutter.
 *
 * This host can only show one View in single ClutterActor.
 *
...
#endif // GGADGET_CLUTTER_SINGLE_VIEW_HOST_H__
