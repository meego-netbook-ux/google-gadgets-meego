...
#ifndef GGADGET_CLUTTER_PIXBUF_IMAGE_H__
#define GGADGET_CLUTTER_PIXBUF_IMAGE_H__

#include <ggadget/clutter/cairo_image_base.h>
...
#endif // GGADGET_CLUTTER_PIXBUF_IMAGE_H__
